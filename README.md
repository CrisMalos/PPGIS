...
This is a simple web app that uses Google Forms and Leaflet to allow data collection using just a modern web browser. Check out the [demo](https://github.com/CrisMalos/PPGIS) and start collecting!
